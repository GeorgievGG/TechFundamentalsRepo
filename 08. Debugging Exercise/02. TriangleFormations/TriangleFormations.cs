    ...
    public class TriangleFormations
    {
        public static void Main()
        {
            ...
            if (isValidTriangle)
            {
                ...
                var rightTriangleCondition1 = Math.Pow(a, 2) + Math.Pow(b, 2) == Math.Pow(c, 2);
                var rightTriangleCondition2 = Math.Pow(b, 2) + Math.Pow(c, 2) == Math.Pow(a, 2);
                var rightTriangleCondition3 = Math.Pow(a, 2) + Math.Pow(c, 2) == Math.Pow(b, 2);
