    ...
    public class PriceChangeAlert
    {
        public static void Main()
        {
            ...
            for (int i = 0; i < numberOfPrices - 1; i++)
            {
                ...
                decimal pricesDiffPercentage = Percentage(previousPrice, currentPrice);
                bool isSignificantDifference = isSignificantCheck(treshhold, pricesDiffPercentage);
        ...
        private static bool isSignificantCheck(decimal treshhold, decimal PricesDiffPercentage)
        {
        ...
        private static decimal Percentage(decimal lastPrice, decimal currentPrice)
        {
